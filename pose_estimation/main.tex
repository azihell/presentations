...
\title{Article review: "3D pose estimation of visual markers"}
...
\begin{frame}[fragile]{MBV: Marker-based vision systems}
  ...
  \begin{itemize}
    ...
    \item \emph{ARToolKitPlus} system was used because of it's accuracy.
  \end{itemize}

\end{frame}

\begin{frame}[fragile]{Square and circular ARtags}
  Cons: squared ARtags have the disadvantages of occlusion and minimum size detection when in comparison.
  ...
  \begin{figure}
    ...
    \caption{Examples of tags used by the author.}
  \end{figure}
